  ...
  return (
    <CardShell>
      <Card className="p-5 sm:p-6">
        <div className="text-xs font-medium tracking-tight text-text-tertiary">{label}</div>
        <div className="mt-2 text-2xl font-semibold tracking-tight text-text-primary sm:text-3xl">
          {value}
        </div>
